...
import { LabelStyles } from "./styles.store.js";
import { isFixed } from "../utilities/index.js";
import { createOffscreenLabelIndicator } from "./offscreenLabel.element.js";
...
export class Label extends HTMLElement {
  ...
  detectOutsideViewport() {
    const hoverText = this.$shadow.firstElementChild.innerText.replace(
      /\s+/g,
      " "
    );
